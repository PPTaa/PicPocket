...
- MVP 목표는 자동 분류 검증이다.
- 앱 이름/프로젝트명은 임시로 `CaptureBox`를 사용한다.
...
- `docs/superpowers/plans/2026-04-25-capturebox-mvp-implementation.md`
...
- 실제 구현 계획은 `docs/superpowers/plans/2026-04-25-capturebox-mvp-implementation.md`를 따른다.
